...
Darkroom.plugins['gray'] = Darkroom.Plugin.extend({

  initialize: function InitDarkroomGreyPlugin() {
    var buttonGroup = this.darkroom.toolbar.createButtonGroup();

    this.greyButton = buttonGroup.createButton({
      image: 'gray',
	  tooltip:'Convert to grayscale'
    });
    
    // Buttons click
    this.greyButton.addEventListener('click', this.greyImage.bind(this));
